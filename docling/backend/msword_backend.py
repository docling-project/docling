...
class MsWordDocumentBackend(DeclarativeDocumentBackend):
    ...
    def __init__(
        ...
        self.base_ilevel: int | None = None
    ...
    def _isolated_list_context(self):
        ...
        saved_base_ilevel = self.base_ilevel
        ...
        try:
            ...
            self.base_ilevel = saved_base_ilevel
    ...
    def _manage_list_structure(
        ...
        *,
        ...
        if self._prev_numid() is None or (
            ...
            base = self.base_ilevel if self.base_ilevel is not None else 0
            start_offset = max(0, prev_indent - base)
            end_offset = max(0, ilevel - base)
            for i in range(
                self.level_at_new_list + start_offset + 1,
                self.level_at_new_list + end_offset + 1,
            ):
            ...
            use_level = self.level_at_new_list + end_offset
