...
class DeepSeekOcrModel(BaseOcrModel):
    ...
    def _init_model(
        ...
        try:
            ...
            raise ImportError(
                ...
                "Please install them via `pip install docling[deepseecocr]` to use this OCR engine. "
    ...
    def _run_ocr(self, image, ocr_rect: BoundingBox) -> list[TextCell]:
        ...
        try:
            ...
            # For MPS compatibility, we pass device and dtype explicitly
            ...
            error_msg = str(e)
            # Detect transformers version incompatibility with MPS model
            if "DynamicCache" in error_msg and (
                "seen_tokens" in error_msg or "get_max_length" in error_msg
            ):
                _log.error(
