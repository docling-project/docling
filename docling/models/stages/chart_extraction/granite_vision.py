...
class ChartExtractionModelGraniteVisionV4(BaseItemAndImageEnrichmentModel):
    SUPPORTED_CHART_TYPES = ["bar_chart", "pie_chart", "line_chart"]
    ...
    def download_models(
        ...
        return download_hf_model(
            repo_id=ChartExtractionModelGraniteVisionV4._model_repo_id,
            # Let's pin it to a specific commit to reduce potential regression errors
            revision=ChartExtractionModelGraniteVisionV4._model_repo_revision,
            local_dir=local_dir,
            force=force,
            progress=progress,
        )
