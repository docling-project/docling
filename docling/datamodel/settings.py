...
class BatchConcurrencySettings(BaseModel):
    ...
    page_chunk_size: Optional[int] = (
        None  # Number of pages per chunk for large document streaming. If None, chunks are disabled. Chunks are treated as independent documents for parallelization.
    )
