...
def get_chandra_test_paths():
    ...
    directory = Path("./tests/data/html_chandra/regression/")
...
def test_chandra_simple_parsing():
    ...
    path = Path("./tests/data/html_chandra/regression/chandra_simple.html")
...
def test_chandra_multiblock_parsing():
    ...
    path = Path("./tests/data/html_chandra/regression/chandra_multiblock.html")
    content = path.read_text()
    source = path.with_suffix(".source.txt").read_text()
...
def test_chandra_list_group_prediction_sample():
    ...
    path = Path("./tests/data/html_chandra/regression/chandra_list_group.html")
    content = path.read_text()
    source = path.with_suffix(".source.txt").read_text()
