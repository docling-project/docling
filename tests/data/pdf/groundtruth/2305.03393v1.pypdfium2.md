...
Maksym Lysak[0000 − 0002 − 3723 − 6960] , Ahmed Nassar[0000 − 0002 − 9468 − 0822] , Nikolaos Livathinos[0000 − 0001 − 8513 − 3491] , Christoph Auer[0000 − 0001 − 5761 − 0422] , − 0002 − 8088 − 0823]

and Peter Staar[0000
...
| # enc-layers | # dec-layers | Language | TEDs | TEDs | TEDs | mAP (0.75) | Inference |
| - | - | - | - | - | - | - | - |
| # enc-layers | # dec-layers | Language |  | (0.75)time (secs) simple complex all complex | all | mAP (0.75) | Inference |
...
| Data set | Language | TEDs | TEDs | TEDs | mAP(0.75) | Inference |
| - | - | - | - | - | - | - |
| Data set | Language |  | mAP(0.75) | all | mAP(0.75) | Inference |
|  |  |  | time (secs) simple complex all complex |  |  |  |
