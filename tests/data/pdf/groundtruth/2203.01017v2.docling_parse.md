...
| - | - | - | - |
|  | [30, 1, 2, 3, 4, …3, 4, 5, 8, 31] | x4 | Encoded Output CELL BBOX DECODER |
| CNN BACKBONE ENCODER | Positional Encoding Masked Multi-Head Attention | Transformer Decoder Network | Linear Attention Network |
| Multi-Head Attention Positional Encoding | Add & Multi-Head Attention | Normalisation | Linear |
| Add & Normalisation | Add & Normalisation |  | Sigmoid |
| Feed Forward Network | Feed Forward | Network | MLP Linear |
| Add & Normalisation | Add & Normalisation |  | Bounding Boxes & Classification |
| Encoded Output | Softmax |  |  |
|  | Predicted | Tags |  |
...
|  |  |  | 論文ファイル | 論文ファイル | 参考文献 | 参考文献 |  | Shares (in millions) | Shares (in millions) | Weighted Average Grant Date Fair | Weighted Average Grant Date Fair |
| - | - | - | - | - | - | - | - | - | - | - | - |
| 出典 | 出典 | ファイル数 | 英語 | 日本語 | 英語 | 日本語 |  |  |  | Value | Value |
| Association for Computational Linguistics(ACL2003) | Association for Computational Linguistics(ACL2003) | 65 | 65 | 0 | 150 | 0 |  | RSUs | PSUs | RSUs | PSUs |
| Computational Linguistics(COLING2002) | Computational Linguistics(COLING2002) | 140 | 140 | 0 | 150 | 0 | Nonvested on January 1 | 1.1 | 0.3 | 90.10 $ | $ 91.19 |
| 電気情報通信学会 | 2003 年総合大会 | 150 | 8 | 142 | 223 | 147 |  |  |  |  |  |
| 情報処理学会第 65 | 回全国大会 (2003) | 177 | 1 | 176 | 150 | 236 | Granted | 0.5 | 0.1 | 117.44 | 122.41 |
| 第 17 回人工知能学会全国大会 | (2003) | 208 | 5 | 203 | 152 | 244 | Vested | (0.5) | (0.1) | 87.08 | 81.14 |
| 自然言語処理研究会第 | 146 〜 155 回 | 98 | 2 | 96 | 150 | 232 | Canceled or forfeited | (0.1) | - | 102.01 | 92.18 |
| WWW から収集した論文 |  | 107 | 73 | 34 | 147 | 96 | Nonvested on December 31 | 1.0 | 0.3 | 104.85 $ | $ 104.51 |
...
5. 9a. Compute the top and bottom boundary of the horizontal band for each grid row (min/max y coordinates per row).
6. 9b. Intersect the orphan's bounding box with the row bands, and map the cell to the closest grid row.
7. 9c. Compute the left and right boundary of the vertical band for each grid column (min/max x coordinates per column).
8. 9d. Intersect the orphan's bounding box with the column bands, and map the cell to the closest grid column.
