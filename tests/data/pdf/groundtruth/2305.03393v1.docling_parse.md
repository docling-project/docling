...
In modern document understanding systems [1,15], table extraction is typically a two-step process. Firstly, every table on a page is located with a bounding box, and secondly, their logical row and column structure is recognized. As of rowspan="2"
...
| Amount Names Extracted Table Images | Encoder | BBox Decoder | BBoxes [x 1 , y 2 , x 2 , y 2 ] [x 1 ', y 2 ', x 2 ', y 2 '] [x 1 '', y 2' ', x 2 '', y 2 ''] ... | BBoxes can be traced back to the original image to extract content 3 1 |
| - | - | - | - | - |
| 1. Item 1000 500 3500 150 unit unit unit unit 2. Item 3. Item 4. Item |  | Structure Decoder | BBoxes in sync with tag sequence C C NL L 2 1 | Structure Tags sequence provide full description of |
|  |  |  | C C C C C C NL NL NL 3 | the table structure |
|  |  |  | C C C C C C NL |  |
...
| # enc-layers | # dec-layers | Language | simple | TEDs complex | all | mAP (0.75) | Inference time (secs) |
| - | - | - | - | - | - | - | - |
...
| Data set | Language | simple | TEDs complex | all | mAP(0.75) | Inference time (secs) |
| - | - | - | - | - | - | - |
