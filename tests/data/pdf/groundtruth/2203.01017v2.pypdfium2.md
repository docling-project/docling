...
where Ta Ta and Tb Tb represent tables in tree structure HTML format. EditDist denotes the tree-edit distance, and |T| represents the number of nodes in T .
...
| Model | TEDS Dataset Simple Complex All |
| - | - |
...
- [13] Thotreingam Kasar, Philippine Barlas, Sebastien Adam, Clement Chatelain, and Thierry Paquet. Learning to detect ´ ´ tables in scanned document images using line information. In 2013 12th International Conference on Document Analysis and Recognition, pages 1185–1189. IEEE, 2013. 2
