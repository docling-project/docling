...
#
# Input audio
# - Defaults to `tests/data/audio/regression/sample_10s.mp3`. Update `audio_path` to your own file if needed.
...
if __name__ == "__main__":
    audio_path = Path("tests/data/audio/regression/sample_10s.mp3")
