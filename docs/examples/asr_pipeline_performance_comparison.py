...
python asr_pipeline_performance_comparison.py --audio tests/data/audio/regression/another_sample.wav
        """,
    )
    ...
    parser.add_argument(
        "--audio",
        type=str,
        help="Path to audio file for testing (default: tests/data/audio/regression/sample_10s.mp3)",
    )
