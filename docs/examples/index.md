...
- 📈 [batch-processing broker research reports](./process_broker_reports.py) — convert → extract key
  financial metrics → audit loop (Markdown with referenced figures + metrics JSON/chart) for report knowledge bases
