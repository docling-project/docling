...
Downloading rapidocr torch zh-Hans models...
Downloading rapidocr onnxruntime zh-Hans models...
Models downloaded into $HOME/.cache/docling/models.
```

To prefetch EasyOCR recognition models for specific languages, repeat
`--easyocr-lang` with the same BCP-47 tags used by `EasyOcrOptions.lang`:

```sh
$ docling-tools models download easyocr --easyocr-lang zh-Hans --easyocr-lang ja
```
