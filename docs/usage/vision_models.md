...
- DocLang (e.g. [Granite for Docling 500M](https://huggingface.co/docling-project/granite-for-docling-500m))
- Markdown
- HTML
...
| `vlm_model_specs.GRANITE_FOR_DOCLING_500M_TRANSFORMERS` | [docling-project/granite-for-docling-500m](https://huggingface.co/docling-project/granite-for-docling-500m) | `Transformers/AutoModelForImageTextToText` | CUDA | 1 |  - |
| `vlm_model_specs.GRANITE_FOR_DOCLING_500M_VLLM` | [docling-project/granite-for-docling-500m](https://huggingface.co/docling-project/granite-for-docling-500m) | `vLLM` | CUDA | 1 |  - |
