...
pub fn resolve_common_entities(content: &mut String) {
    let entities = [
        ...
        ("&minus;", "\u{2212}"), ("&plusmn;", "\u{00B1}"),
        ("&deg;", "\u{00B0}"), ("&micro;", "\u{00B5}"),
        ...
        ("&ohgr;", "\u{03C9}"), ("&agr;", "\u{03B1}"), ("&bgr;", "\u{03B2}"),
        ("&ggr;", "\u{03B3}"), ("&dgr;", "\u{03B4}"), ("&egr;", "\u{03B5}"),
        ("&zgr;", "\u{03B6}"), ("&eegr;", "\u{03B7}"), ("&thgr;", "\u{03B8}"),
        ("&igr;", "\u{03B9}"), ("&kgr;", "\u{03BA}"), ("&lgr;", "\u{03BB}"),
        ("&mgr;", "\u{03BC}"), ("&ngr;", "\u{03BD}"), ("&xgr;", "\u{03BE}"),
        ("&pgr;", "\u{03C0}"), ("&rgr;", "\u{03C1}"), ("&sgr;", "\u{03C3}"),
        ("&tgr;", "\u{03C4}"), ("&ugr;", "\u{03C5}"), ("&phgr;", "\u{03C6}"),
        ("&khgr;", "\u{03C7}"), ("&psgr;", "\u{03C8}"),
        ("&Agr;", "\u{0391}"), ("&Bgr;", "\u{0392}"), ("&Ggr;", "\u{0393}"),
        ("&Dgr;", "\u{0394}"), ("&EEgr;", "\u{0397}"), ("&THgr;", "\u{0398}"),
        ("&Lgr;", "\u{039B}"), ("&Xgr;", "\u{039E}"), ("&Pgr;", "\u{03A0}"),
        ("&Sgr;", "\u{03A3}"), ("&PHgr;", "\u{03A6}"), ("&PSgr;", "\u{03A8}"),
        ("&OHgr;", "\u{03A9}"),
        ("&le;", "\u{2264}"), ("&ge;", "\u{2265}"), ("&ne;", "\u{2260}"),
        ("&infin;", "\u{221E}"), ("&sum;", "\u{2211}"), ("&prod;", "\u{220F}"),
        ("&radic;", "\u{221A}"), ("&prop;", "\u{221D}"),
        ("&larr;", "\u{2190}"), ("&rarr;", "\u{2192}"),
        ("&uarr;", "\u{2191}"), ("&darr;", "\u{2193}"),
        ("&harr;", "\u{2194}"),
        ("&frac12;", "\u{00BD}"), ("&frac14;", "\u{00BC}"), ("&frac34;", "\u{00BE}"),
        ("&nbsp;", "\u{00A0}"),
        ("&emsp;", "\u{2003}"), ("&ensp;", "\u{2002}"),
        ("&thinsp;", "\u{2009}"),
        ("&equals;", "="), ("&plus;", "+"), ("&comma;", ","),
        ("&period;", "."), ("&colon;", ":"), ("&semi;", ";"),
        ("&excl;", "!"), ("&quest;", "?"), ("&num;", "#"),
        ("&percnt;", "%"), ("&dollar;", "$"), ("&commat;", "@"),
        ("&ast;", "*"), ("&sol;", "/"), ("&bsol;", "\\"),
        ("&verbar;", "|"), ("&hyphen;", "-"), ("&lowbar;", "_"),
        ("&lpar;", "("), ("&rpar;", ")"),
        ("&lbrace;", "{"), ("&rbrace;", "}"),
        ...
        ("&af;", "\u{2061}"), ("&it;", "\u{2062}"),
        ("&ic;", "\u{2063}"), ("&ii;", "\u{2064}"),
        ("&ApplyFunction;", "\u{2061}"), ("&InvisibleTimes;", "\u{2062}"),
    ];
