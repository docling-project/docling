...
- 🗂️ Parsing of [multiple document formats][supported_formats] including PDF, DOCX, PPTX, XLSX, HTML, EPUB, Apple Pages & Numbers, WAV, MP3, WebVTT, Box Notes, email formats (EML, MSG), images (PNG, TIFF, JPEG, ...), LaTeX, DocLang, plain text, and more
...
- 🍎 Parsing of Apple Pages (`.pages`) documents and Numbers (`.numbers`) spreadsheets, both container generations (2013 onwards and iWork '09)
